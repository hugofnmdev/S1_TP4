...
git clone LOGIN@git.cri.epita.fr:p/2026-s1-caml/tp4-LOGIN
...
└─📁tp4-LOGIN/
  ...
  ├─🐫list_tools.ml
  ├─🐫gameOfLife.ml
  └─🐫gameOfLife_bonus.ml # optional

Exercises from the "Toolbox" section must be in list_tools.ml, "The Game" section must be in gameOfLife.ml and "Bonus" section must be in gameOfLife_bonus.ml.
📝Provided files
